...
def _tools_in_params_anth(params: dict) -> bool:
                    ...
                    [
                        {
                            ...
                            "tool_use_id": str(curr.tool_call_id),
                        }
                    ]
                )
...
def _format_image_anth(image_url: str) -> Dict:
    """
...
def _format_messages_anth(
    ...
    # print("---PACKAGE KE ANDAR MESSAGES---")
    # print(messages)
    ...
    for i, message in enumerate(merged_messages):
        ...
        role = _message_type_lookups_anth[message.type]
            ...
            for block in message.content:
                if isinstance(block, str):
                    ...
                    if "type" not in block:
                        ...
                        # convert format
                        source = _format_image_anth(block["image_url"]["url"])
                        ...
                        tool_content = _format_messages_anth(
    ...
    **NOTE**: Any param which is not explicitly supported will be passed directly to the
    ...
    def _get_request_payload(
        ...
        **kwargs: Dict,
        ...
        system, formatted_messages = _format_messages_anth(messages)
        payload = {
            "model": self.model,
            "max_tokens": self.max_tokens,
    ...
    def _stream(
        ...
        **kwargs: Any,
        ...
        coerce_content_to_string = not _tools_in_params_anth(payload)
        for event in stream:
